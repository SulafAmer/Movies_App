...
/// data : {"movie_count":37421,"limit":20,"page_number":1,"movies":[...]}

class BrowseModel {
  BrowseModel({this.status, this.statusMessage, this.data, this.meta});
...
class Movies {
  ...
  Movies.fromJson(dynamic json) {
    ...
    // FIX:
    // rating can come from API as int or double
